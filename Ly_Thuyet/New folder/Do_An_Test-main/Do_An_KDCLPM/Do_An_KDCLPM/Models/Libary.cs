...
namespace Do_An_KDCLPM.Models
{
    public class Libary
    {
        ...
        public bool sendMail(string mailTo,string title, string body, string urlImage)
        {
            ...
            smtp.Port = 587;
            smtp.EnableSsl = true;
            urlImage = urlImage.Replace("http://localhost:60710/", AppDomain.CurrentDomain.BaseDirectory);
